...
const STORAGE_KEY = 'remixware-theme'
const DEFAULT_THEME: Theme = 'dark'

/**
 * Inlined in <head> so the correct class exists on the very first paint.
 *
 * Dark is the brand default and wins unless the visitor has explicitly chosen
 * light. To follow the OS preference instead, replace the fallback with:
