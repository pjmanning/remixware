  ...
  head: () => {
    ...
    return {
      ...
      links: [
        ...
        {
          rel: 'stylesheet',
          href: 'https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400..800&family=Space+Grotesk:wght@300..700&family=JetBrains+Mono:wght@400;500&display=swap',
        },
      ],
  ...
  return (
    <MarketingShell>
      <div className="nj-shell flex min-h-[62vh] flex-col items-center justify-center py-24 text-center">
        ...
        <h1 className="mt-4 text-5xl font-semibold md:text-7xl">Nothing roosting here.</h1>
        <p className="mt-5 max-w-md text-muted-foreground text-pretty">
          The page you were after has moved or never existed. Try the links below.
        </p>
